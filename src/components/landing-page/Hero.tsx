  ...
  return (
    <SectionWrapper>
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-center gap-8 ">
        ...
        <div className=" relative flex-1 w-full  aspect-[5/3] min-h-[250px] lg:min-h-[370px] lg:min-w-[520px] max-w-[600px] border-4 border-primary-800 bg-black/50 rounded-sm ">
          <Image
            src="/casefile.png"
            alt="Hero Image"
            fill
